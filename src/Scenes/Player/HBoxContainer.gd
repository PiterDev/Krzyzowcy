...
var unused_bullet_texture = preload("res://Assets/unusedammo.png")
...
func _process(delta):
	if Globals.ammo == 3:
		bullet_texturerect1.set_texture(unused_bullet_texture)
		bullet_texturerect2.set_texture(unused_bullet_texture)
		bullet_texturerect3.set_texture(unused_bullet_texture)
	if Globals.ammo == 2:
